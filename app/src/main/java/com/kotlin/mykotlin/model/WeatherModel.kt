...
data class CurWeather(val curCity: String, val curTemp: String, val conditions: String, val date: String, val high: Int, val low: Int)
...
data class DayForecastWeather(val date: String, val conditions: String, val high: Int, val low: Int, val icon_url: String, val pop: String)
